...
var ReactAnySliderDots = function (_a) {
    ...
    var _e = (0, react_1.useState)({ left: 0, right: visibleDotsCount - 1 }), visibleDotsIndexes = _e[0], setVisibleDotsIndexes = _e[1];
    ...
    return (react_1["default"].createElement("div", { className: 'react-any-slider-dots', style: { maxWidth: visibleBlockWidth } },
        react_1["default"].createElement("div", { className: 'react-any-slider-dots__container', ref: contentRef, style: { gap: dotGap } }, Array(dotsCount)
            .fill(0)
            .map(function (_, index) { return (react_1["default"].createElement("div", { key: index, className: makeDotClassName(index === 0 ||
                index === dotsCount - 1 ||
                (index > visibleDotsIndexes.left && index < visibleDotsIndexes.right), activeIndex === index), style: { width: dotSize, height: dotSize } })); }))));
};
exports["default"] = ReactAnySliderDots;
