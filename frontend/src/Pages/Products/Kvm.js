    ...
    <div className="row">
        ...
        <div className="col-lg-12 mb-30">
            <div className="feature__content">
                ...
                <h2 className="theme-color fw-700 mb-30">KVM</h2>
                ...
                <img src="../assets/images/service/technology-elements-background.jpeg" class="card-img-top mb-5" alt="audio video"/>

                <h2 className="theme-color fw-700 mb-30">All KVM Products</h2>
                ...
                <div className='container'>
                  <div className='row'>
                    ...
                    <div class="card" >
                          ...
                          <div class="card-body">
                            <h5 class="card-title">Desktop KVM</h5>
                    ...
                    <div class="card" >
                          ...
                          <div class="card-body">
                            <h5 class="card-title">Matrix Systems</h5>
                    ...
                    <div class="card" >
                          ...
                          <div class="card-body">
                            <h5 class="card-title">Secure KVM</h5>
                    ...
                    <div class="card" >
                          ...
                          <div class="card-body">
                            <h5 class="card-title">Rackmount KVM</h5>
                    ...
                    <div class="card" >
                          ...
                          <div class="card-body">
                            <h5 class="card-title">LCD Console Trays</h5>
                    ...
                    <div class="card" >
                          <img src="../assets/images/service/futuristic-smart-city-with-5g-global-network-technology.jpeg" style={{height:"15em"}} class="card-img-top" alt="infrastructure"/>
                          <div class="card-body">
                            <h5 class="card-title">KVM Cables</h5>
